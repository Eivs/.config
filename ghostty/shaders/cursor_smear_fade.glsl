...
// vec4 LightRed    = vec4(0.988, 0.263, 0.275, 1.0);   // #fc4346
// vec4 LightGreen  = vec4(0.314, 0.984, 0.486, 1.0);   // #50fb7c
// vec4 lightYellow = vec4(0.941, 0.984, 0.549, 1.0);   // #f0fb8c
// vec4 lightBlue   = vec4(0.286, 0.729, 1.000, 1.0);   // #49baff
// vec4 lightMegenta= vec4(0.988, 0.298, 0.706, 1.0);   // #fc4cb4
// vec4 lightCyan   = vec4(0.545, 0.914, 0.996, 1.0);   // #8be9fe


const vec4 TRAIL_COLOR = vec4(1., 1., 1., 1.);
